...
\renewcommand{\plaintitle}{List of abbreviations}
...
\clearpage
% Change the title in the header
\renewcommand{\plaintitle}{Table of contents}
% This construct removes some spacing between the dotted line and the page number
{\def\makebox[#1][#2]#3{#3}%
    \tableofcontents
}
...
\part{Main part}
An example for a quote would be "Someone intelligent said this"\citebib{testEntry}{S. 123}{}. An indirect quote would look like this.\citebib{testEntry}{S. 321}{vgl. }
\part{Conclusion}
