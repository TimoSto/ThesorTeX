...
func HandleUploadEntries(fs filesystem.FileSystem, cfg config.Config) func(w http.ResponseWriter, r *http.Request) {
	fn := func(w http.ResponseWriter, r *http.Request) {
		...
		err = entries.SaveEntries(fs, cfg, query["project"][0], uploadedEntries)
		if err != nil {
